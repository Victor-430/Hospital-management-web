...
export const AvaSection = () => {
  ...
  return (
    <div className="bg-[#053C6D] py-20 ">
      <div className=" inset-0 bg-gradient-to-r from-[#053C6D] via-[#DAF1FB] to-[#053C6D]"></div>
      <div className="container mx-auto px-6 relative z-10">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div className="animate-pulse">
            <Image src={Ava} alt="ava img" className="w-full" />
          </div>

          <div className="text-white space-y-8">
            <div className="space-y-6">
              <h2 className="text-3xl sm:text-5xl text-center lg:text-left font-bold leading-tight">
